...
namespace Web_eticaret.Models
{
    ...
    public partial class burak_eticaretEntities : DbContext
    {
        public burak_eticaretEntities()
            : base("name=burak_eticaretEntities")
        {
        }
        ...
        public virtual DbSet<vw_urun_detaylari> vw_urun_detaylari { get; set; }
        public virtual DbSet<vw_tum_urunler> vw_tum_urunler { get; set; }
